...
// Generated on 2026-05-01T17:00:55.285Z
  ...
  'clefable': [
    {
      ...
      name: 'Mega Clefable',
      chineseName: '超级皮可西',
      englishName: 'Mega Clefable',
      japaneseName: 'メガピクシー',
      iconRef: artwork(10036),
      isMega: true,
      requiredItemId: 'clefablite',
      types: ['Fairy'],
      baseStats: { hp: 95, attack: 70, defense: 73, specialAttack: 125, specialDefense: 120, speed: 60 },
  ...
  'victreebel': [
    {
      ...
      chineseName: '超级大食花',
      englishName: 'Mega Victreebel',
      japaneseName: 'メガウツボット',
      iconRef: artwork(10071),
      isMega: true,
      requiredItemId: 'victreebelite',
      types: ['Grass', 'Poison'],
      baseStats: { hp: 80, attack: 130, defense: 80, specialAttack: 120, specialDefense: 80, speed: 90 },
  ...
  'starmie': [
    {
      ...
      name: 'Mega Starmie',
      chineseName: '超级宝石海星',
      englishName: 'Mega Starmie',
      japaneseName: 'メガスターミー',
      iconRef: artwork(10121),
      isMega: true,
      requiredItemId: 'starminite',
      types: ['Water', 'Psychic'],
      baseStats: { hp: 60, attack: 85, defense: 100, specialAttack: 130, specialDefense: 100, speed: 125 },
      abilities: ['analytic'],
      legalInCurrentRule: true,
      sourceRefs: megaRefs,
    },
  ...
  'dragonite': [
    {
      ...
      name: 'Mega Dragonite',
      chineseName: '超级快龙',
      englishName: 'Mega Dragonite',
      japaneseName: 'メガカイリュー',
      iconRef: artwork(10149),
      isMega: true,
      requiredItemId: 'dragoninite',
      types: ['Dragon', 'Flying'],
      baseStats: { hp: 91, attack: 164, defense: 105, specialAttack: 120, specialDefense: 110, speed: 100 },
  ...
  'meganium': [
    {
      ...
      name: 'Mega Meganium',
      chineseName: '超级大竺葵',
      englishName: 'Mega Meganium',
      japaneseName: 'メガメガニウム',
      iconRef: artwork(10154),
      isMega: true,
      requiredItemId: 'meganiumite',
      types: ['Grass'],
      baseStats: { hp: 80, attack: 82, defense: 130, specialAttack: 113, specialDefense: 130, speed: 80 },
      abilities: ['thick-fat'],
      legalInCurrentRule: true,
      sourceRefs: megaRefs,
    },
  ...
  'feraligatr': [
    {
      ...
      chineseName: '超级大力鳄',
      englishName: 'Mega Feraligatr',
      japaneseName: 'メガオーダイル',
      iconRef: artwork(10160),
      isMega: true,
      requiredItemId: 'feraligite',
      types: ['Water'],
      baseStats: { hp: 85, attack: 135, defense: 120, specialAttack: 79, specialDefense: 93, speed: 88 },
