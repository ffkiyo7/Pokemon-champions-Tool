...
export const dataSourceManifest: DataSourceManifest = {
  ...
  sources: [
    ...
    },
    {
      ...
      notes: 'Old-gen Mega Evolution competitive data (stats, types, abilities) sourced from well-documented game data. Chinese names from PokeAPI species endpoint. Champions-only Megas (18 entries) retain shell status without fabricated data.',
    },
  ],
